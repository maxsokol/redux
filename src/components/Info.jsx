...
<p><b>Недочеты, которые наврядли допущу на рабочем проекте: </b></p>
<ol>
  <li>Этот пункт не считается :) Проект выполнен на JS, а не на TypeScript. TypeScript еще не изучил.</li>
