...
<ol>
  <li>Нет авторизации.</li>
  <li>Нет триминга для полей</li>
  <li>Стоит добавить запрет на использование одинковых имен товаров и каталогв.</li>
  <li style={{ display: 'none' }}>Если во время заполнения форм нажать на фон, форма запомнит данные, но не покажет их при повторном открытии.</li>
  <li style={{ display: 'none' }}>После добавления товара форма помнит содержание все полей, хотя не показывает их. Т.е.
     при нажатии "Добавить" появится еще один такой же товар.</li>
  <li style={{ display: 'none' }}>При нажатии кнопки submit у незаполненой формы не подсвечивается красным, 
  где не заполнено. И не переводится курсор туда.</li>
...
<ol>
  ...
  <li><a href="https://www.youtube.com/watch?v=0N60mKMlwiA">Об авторизации OAuth 2.0</a></li>
</ol>
